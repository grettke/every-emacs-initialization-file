...
[[https://gitlab.com/yisraeldov/emacs-d]][My working .emacs.d]] Using emacs as a desktop environment and PHP ide. I am in the process of redoing the ~init.el~ to be done in orgmode and be cleaner, on branch [[https://gitlab.com/yisraeldov/emacs-d/tree/init-cleanup][init-cleanup]] and documenting the process on [[YouTube][https://www.youtube.com/playlist?list=PLrFss89N5XNw8rTgI2fVhSj9Y62TpphFI]].
